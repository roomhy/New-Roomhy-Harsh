...
export function VisitorPassCard({ visitorName, visitorPhone, tenantName, expectedTime, propertyName, propertyAddress, passId, passDate, approvedBy, verifyUrl }) {
  const fmtTime = (iso) => {
    if (!iso) return "—";
          ...
          <div className="text-center" style={{ marginBottom: "24px", position: "relative", zIndex: 2 }}>
            ...
            <div className="flex justify-center" style={{ marginTop: "12px" }}>
              <span style={{
                ...
                Approved by Owner{approvedBy ? ` • ${approvedBy}` : ""}
              </span>
            </div>
          </div>
